...
public class ArticuloStockDAOMySQLMySQL extends BaseDAOMySQL<ArticuloStock, Integer> implements IArticuloStockDAO {

    public ArticuloStockDAOMySQLMySQL(Connection conexion) throws SQLException {
        super(conexion);
